...
\documentclass{book}
\usepackage{amssymb, amsmath, amsthm, graphicx, makeidx, url, longtable, booktabs, wrapfig} %hyperref, tcolorbox, xcolor, wrapfigure
%\usepackage{eso-pic}
...
\end{itemize}
\end{itemize}
\noindent {\bf Acknowledgments.} I gratefully acknowledge support for the initial development of this book with a grant from the Pennsylvania State System of Higher Education (PASSHE) Faculty Professional Development Committee. \\ % License information
