...
\subsection{Exercises}
    For each function  $f(x)$  in Problems  1 - 6, 
    \begin{enumerate}


(a) calculate  msec = and simplify 	(b)	determine   mtan   =   msec 	
(c) evaluate  mtan  at  x = 2 ,  (d)	find the equation of the line tangent to the graph of  f  at  (2, f(2) )

6.	f(x) = 3x – 7	7.	f(x) = 2 – 7x	8.	f(x) = ax + b   where  a  and  b  are constants

9.	f(x) =  x2  + 3x	10.	f(x) =  8 – 3x2  	11.	f(x) = ax2 + bx + c  where a, b and c are constants
