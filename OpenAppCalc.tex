...
\usepackage{amssymb, amsmath, amsthm, graphicx, makeidx, url, longtable, booktabs, wrapfig, subcaption, enumitem, tikz, pgfplots, multicol, cutwin} %hyperref, tcolorbox, wrapfigure
...
\end{itemize}
\end{itemize}
\noindent {\bf Acknowledgements.} I gratefully acknowledge support for the initial development of this book with a grant from the Pennsylvania State System of Higher Education (PASSHE) Faculty Professional Development Committee. \\
...
\input{tex/chap4-multivariable}
\input{tex/chap5-integrals}
