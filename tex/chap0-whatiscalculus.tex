...
\solution To find the total accumulation of snow, we can break this image up in a natural way into four shapes: the triangle, trapezoid, square, and triangle over the intervals $[0, 4]$, $[4, 6]$, $[6, 8]$, and $[8, 12]$, respectively. Therefore, the total shaded area is (note the units):
\begin{align*}
