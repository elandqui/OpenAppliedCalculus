...
Now, we consider a different question that is an example of an instantaneous rate of change, and example of a question that is significantly different from the previous example about average velocity.
\begin{example}
